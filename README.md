...
Member2017_2018 = merge(Member2017_2018, SystemIDConverter, by = "SYSTEM_ID", all = TRUE)
dim(Member2017_2018)
head(Member2017_2018)
...
AllPassport = merge(Member2017_2018, PHARMCLAIMS_2017_2018, by = "SYSTEM_ID", all = TRUE)
dim(AllPassport)



### Now try provider data
head(Provider2017)
head(Provider2018)

Provider2017_2018 = rbind(Provider2017, Provider2018)

AllPassport = merge(AllPassport, Provider2017_2018, by = "SYSTEM_ID", all = TRUE)
dim(AllPassport)

## now Claims need to clean up claims before you merge too much data
#Claims2017_2018 = rbind(Claims2017, Claims2018)
...
dim(InpatClaimsData)
AllPassport = merge(AllPassport, InpatClaimsData, by = "SYSTEM_ID", all = TRUE)
dim(AllPassport)
...
dim(InpatAvatarData)
AllPassport = merge(AllPassport, InpatAvatarData, by = "SYSTEM_ID", all = TRUE)
dim(AllPassport)
...
AllPassport = merge(AllPassport, OutpatClaimsData, by = "SYSTEM_ID", all = TRUE)
dim(AllPassport)
object.size(AllPassport)
