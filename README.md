...
dim(InpatAvatarData)
head(InpatAvatarData)
InpatAvatarData = InpatAvatarData[c("SYSTEM_ID", "DxCode1", "RowTotal", "AvatarID", "ServiceCode", "MissedVisits", "NumServices", "AvatarClient_ID.x")]
names(InpatAvatarData)[5] = "AvatarClient_ID" 
...
head(OutpatClaimsData)
OutpatClaimsData = OutpatClaimsData[c("SYSTEM_ID", "DxCode1", "RowTotal", "MemberTotal", "AvatarClient_ID.x")]
names(OutpatClaimsData)[5] = "AvatarClient_ID"
