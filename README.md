...
HCS_Passport
```{r}
HCS_PassportTest = na.omit(HCS_Passport)
dim(HCS_PassportTest)
...
HCS_PassportNAs = data.frame(is.na(HCS_Passport))
HCS_PassportNAs$NAs = apply(HCS_PassportNAs, 1, sum)
HCS_PassportNAs$NAs = HCS_PassportNAs$NAs / dim(HCS_PassportNAs)[2]
